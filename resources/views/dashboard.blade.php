...
<body class="bg-gray-50 dark:bg-gray-800 min-h-screen">
    ...
    <div class="flex min-h-screen">
        ...
        <div x-data="{ showModal: false, editBook: null }" class="mt-4 flex space-x-2">
    <!-- Edit Button -->
    <button 
        class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded"
        @click="showModal = true; editBook = { id: {{ $book->id }}, title: '{{ $book->title }}', genre: '{{ $book->genre }}', description: '{{ $book->description }}', status: '{{ $book->status }}' }">
            ...
            <form 
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        name="description" 
                        class="w-full p-2 border border-gray-300 rounded" 
                        x-text="editBook.description"></textarea>
                </div>
                <div>
                    <label for="status" class="block font-medium">Status</label>
                    <select 
                ...
                <div class="flex justify-end space-x-4">
                    <button type="button" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600" @click="showModal = false">Cancel</button>
